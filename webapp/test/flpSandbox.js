		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comcstiproveedorescrudfrontend001-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcstiproveedorescrudfrontend001-display": {
								"semanticObject": "comcstiproveedorescrudfrontend001",
								"action": "display",
								"description": "CRUD Proveedores",
								"title": "CRUD Proveedores",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.csti.proveedores.crud.frontend001",
									"url": sap.ui.require.toUrl("com/csti/proveedores/crud/frontend001")
								}
							}
						}
					}
